#pragma checksum "C:\Users\ndefi\Coding\BluetoothHRacq\BluetoothLE\shared\Scenario1_Discovery.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "8991C296E9906E527CD684717BE8CD30"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SDKTemplate
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IScenario1_Discovery_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 58 && columnNumber == 23)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 9: // Scenario1_Discovery.xaml line 56
                    ...
                    case 10: // Scenario1_Discovery.xaml line 49
                        ...
                        break;
                    case 11: // Scenario1_Discovery.xaml line 50
            ...
            private void Invoke_M_IsNotNull_3601695287(int phase)
            {
                global::System.Object p0;
                if (!TryGet_ResultsListView_SelectedItem(out p0)) { return; }
                global::System.Boolean result = this.dataRoot.IsNotNull(p0);
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Scenario1_Discovery.xaml line 50
            ...
            private void Update_(global::SDKTemplate.Scenario1_Discovery obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_M_IsNotNull_3601695287(phase);
                    }
                }
                else
                {
                    ...
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.UpdateFallback_M_IsNotNull_3601695287(phase);
                    }
                }
            ...
            private void Update_M_IsNotNull_3601695287(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    if (!isobj11IsEnabledDisabled)
                    {
                        this.PendingFunctionBindings["M_IsNotNull_3601695287"] = new InvokeFunctionDelegate(this.Invoke_M_IsNotNull_3601695287); 
                    }
                }
            }
            ...
            private void UpdateFallback_M_IsNotNull_3601695287(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Scenario1_Discovery.xaml line 50
